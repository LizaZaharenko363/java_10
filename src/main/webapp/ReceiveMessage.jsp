...
<form action="receive-message" method="post">
    ...
    <select id="messageSelector" name="messageSelector">
        ...
        <option value="Priority > 5">High Priority</option>
        <option value="Priority <= 5">Low Priority</option>
...
<jsp:useBean id="messageReceiverBean" class="com.example.lab10.MessageReceiverBean" scope="application"/>
